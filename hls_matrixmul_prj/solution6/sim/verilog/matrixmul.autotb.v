...
`define AUTOTB_TVIN_a_0_out_wrapc  "../tv/rtldatafile/rtl.matrixmul.autotvin_a_0.dat"
`define AUTOTB_TVIN_a_1_out_wrapc  "../tv/rtldatafile/rtl.matrixmul.autotvin_a_1.dat"
`define AUTOTB_TVIN_a_2_out_wrapc  "../tv/rtldatafile/rtl.matrixmul.autotvin_a_2.dat"
`define AUTOTB_TVIN_b_0_out_wrapc  "../tv/rtldatafile/rtl.matrixmul.autotvin_b_0.dat"
`define AUTOTB_TVIN_b_1_out_wrapc  "../tv/rtldatafile/rtl.matrixmul.autotvin_b_1.dat"
`define AUTOTB_TVIN_b_2_out_wrapc  "../tv/rtldatafile/rtl.matrixmul.autotvin_b_2.dat"
...
parameter LENGTH_a_0 = 3;
parameter LENGTH_a_1 = 3;
parameter LENGTH_a_2 = 3;
...
wire [1 - 1 : 0]    arraya_0_we0, arraya_0_we1;
...
wire [1 - 1 : 0]    arraya_1_we0, arraya_1_we1;
...
wire [1 - 1 : 0]    arraya_2_we0, arraya_2_we1;
...
wire [1 - 1 : 0]    arrayb_0_we0, arrayb_0_we1;
...
wire [1 - 1 : 0]    arrayb_1_we0, arrayb_1_we1;
...
wire [1 - 1 : 0]    arrayb_2_we0, arrayb_2_we1;
...
assign arrayres_address1 = res_address1;
assign arrayres_ce1 = res_ce1;
assign arrayres_we1[0] = res_we1;
assign arrayres_we1[1] = res_we1;
assign arrayres_din1 = res_d1;
