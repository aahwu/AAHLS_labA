...
tr.import<1>((char*)__xlx_apatb_param_a_0, 3, 0);
  }
...
tr.import<1>((char*)__xlx_apatb_param_a_1, 3, 0);
  }
...
tr.import<1>((char*)__xlx_apatb_param_a_2, 3, 0);
  }
...
if (__xlx_apatb_param_a_2) {
for (size_t i = 0; i < 3; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_a_2 + i * 1;
std::string s = formatData(pos, 8);
