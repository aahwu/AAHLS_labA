set SynModuleInfo {
  {SRCNAME matrixmul MODELNAME matrixmul RTLNAME matrixmul IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME matrixmul_mac_muladd_8s_8s_2ns_16_4_1 RTLNAME matrixmul_mac_muladd_8s_8s_2ns_16_4_1 BINDTYPE op TYPE all IMPL dsp48 LATENCY 3 ALLOW_PRAGMA 1}
    }
  }
}
